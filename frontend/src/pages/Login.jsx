    ...
    <div style={{ minHeight: '100vh', background: '#070707', color: '#f0ece4', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        .login-card { background: #0c0c0c; border: 1px solid #161616; border-radius: 4px; padding: 52px; width: 100%; max-width: 460px; animation: fadeUp 0.6s ease both; }
        .input-field { width: 100%; background: #080808; border: 1px solid #1a1a1a; border-radius: 2px; padding: 14px 18px; font-size: 14px; color: #f0ece4; outline: none; font-family: 'Montserrat', sans-serif; transition: all 0.2s ease; }
        .input-field:focus { border-color: #e8a020; background: #0a0a0a; }
        .input-field::placeholder { color: #2a2a2a; }
        .submit-btn { width: 100%; padding: 16px; background: #e8a020; border: none; border-radius: 2px; color: #070707; font-size: 11px; font-weight: 800; cursor: pointer; font-family: 'Montserrat', sans-serif; letter-spacing: 0.15em; text-transform: uppercase; transition: all 0.2s ease; }
        .submit-btn:hover:not(:disabled) { background: #f0b030; transform: translateY(-2px); }
        .submit-btn:disabled { opacity: 0.5; cursor: not-allowed; }
        .toggle-btn { background: none; border: none; color: #e8a020; cursor: pointer; font-size: 13px; font-family: 'Montserrat', sans-serif; font-weight: 600; text-decoration: underline; }
        .input-label { font-family: 'Montserrat', sans-serif; font-size: 10px; color: #444; display: block; margin-bottom: 8px; letter-spacing: 0.15em; text-transform: uppercase; font-weight: 600; }
      `}</style>
      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%', padding: '24px' }}>
        ...
        <div className="login-card" style={{ margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            ...
            <p style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '13px', color: '#444' }}>
